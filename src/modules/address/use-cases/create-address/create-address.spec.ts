...
describe('Create Address', () => {
  ...
  it('should not be able to create a addres with no zip_code is provided', async () => {
    const user: ICreateUserDTO = {
      name: 'user',
      phone: 'user_phone',
      password: '1234',
  ...
  it('should not be able to create a addres with no state is provided', async () => {
    const user: ICreateUserDTO = {
      name: 'user',
      phone: 'user_phone',
      password: '1234',
  ...
  it('should not be able to create a number with no street is provided', async () => {
    const user: ICreateUserDTO = {
      name: 'user',
      phone: 'user_phone',
      password: '1234',
